...
var _DaTabActions = require('../actions/DaTabActions');

var _DaTabActions2 = _interopRequireDefault(_DaTabActions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var DaTabStore = function () {
	function DaTabStore() {
		_classCallCheck(this, DaTabStore);

		this.bindActions(_DaTabActions2.default);
		this.lanes = [];
	}

	_createClass(DaTabStore, [{
		key: 'create',
